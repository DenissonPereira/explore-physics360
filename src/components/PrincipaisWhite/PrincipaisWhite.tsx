...
import './PrincipaisWhite.sass'
import './PrincipaisWhiteResponsivo.sass'

const PrincipaisWhite = () => {
    return (
        <div className='principais'>
            ...
            <div className="principal_white">
                   <div className="card_atomo_white" id='card_1'>
                ...
                <div className="principal_white">
                   <div className="card_atomo_white" id='card_2'>
                    <div className="inner_atomo">
                        <img src={GalaxiaAzul} alt="" />
                    </div>
                ...
                <div className="principal_white">
                   <div className="card_atomo_white" id='card_3'>
                    <div className="inner_atomo">
                        <img src={GalaxiaAzul} alt="" />
                    </div>
                ...
                <div className="principal_white">
                   <div className="card_atomo_white" id='card_4'>
                    <div className="inner_atomo">
                        <img src={GalaxiaAzul} alt="" />
                    </div>
...
export default PrincipaisWhite